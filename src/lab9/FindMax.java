...
public class FindMax {
	...
	public void printMax() {
		...
		*/
		MyTask r1 = new MyTask(0,29);
		MyTask r2 = new MyTask(30,59);
		MyTask r3 = new MyTask(60,89);
		...
		System.out.println("Result of t1:" + r1.getResult());
		System.out.println("Result of t2:" + r2.getResult());
		System.out.println("Result of t3:" + r3.getResult());
		int max = r1.getResult();
		if(r2.getResult() > max) max = r2.getResult();
		if(r3.getResult() > max) max = r3.getResult();
		System.out.println("the max value is " + max);
	}
